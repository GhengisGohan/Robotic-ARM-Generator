...
def generate_3d_parts (roboticarm_dic, display):
    ...
    print "base_E = {}".format(base_bLen)
    print "wrist_E = {}".format(wrist_bLen)
    print "humerus_E = {}".format(roboticarm_dic[dic_humerus][dic_servoData][dic_servoSizes][dic_E])
    print "base_Armlength = {}".format(base_length)
    print "humerus_Armlength = {}".format(humerus_length)
    print "ulna_Armlength = {}".format(ulna_length)
    print "wrist_Armlength = {}".format(wrist_length)

    print "base_height = {}".format(base_height)
    print "humerus_height = {}".format(humerus_height)
    print "ulna_height = {}".format(ulna_height)
    print "wrist_height = {}".format(wrist_height)
